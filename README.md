In the file LULU_bug_corrected.R, there is a corrected version of the LULU program that fixes the bug reported by Mahé when running MUMU (see https://github.com/tobiasgf/lulu/issues/8).
